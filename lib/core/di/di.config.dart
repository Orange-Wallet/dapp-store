...
import 'package:dappstore/core/permissions/permissions_cubit.dart' as _i7;
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i5.Downloader>(() => _i5.Downloader());
  gh.lazySingleton<_i6.InjectedWeb3Cubit>(() => _i6.InjectedWeb3Cubit());
  gh.lazySingleton<_i7.Permissions>(() => _i7.Permissions());
  gh.lazySingleton<_i8.PwaWebviewCubit>(() => _i8.PwaWebviewCubit());
  return getIt;
}
