...
import 'package:dappstore/core/platform_channel/platform_channel_cubit.dart'
    as _i14;
import 'package:dappstore/core/theme/i_theme_cubit.dart' as _i26;
...
import 'package:dappstore/core/theme/theme_cubit.dart' as _i27;
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i19.IWalletConnectCubit>(() => _i20.WalletConnectCubit());
  gh.lazySingleton<_i21.WalletConnect>(() => _i21.WalletConnect());
  gh.lazySingleton<_i22.IDownloader>(
      () => _i23.DownloaderCubit(permissionsCubit: gh<_i9.IPermissions>()));
  gh.lazySingleton<_i24.IForegroundService>(() => _i25.ForegroundService(
      platformChannelCubit: gh<_i11.IPlatformChannelCubit>()));
  gh.lazySingleton<_i26.IThemeCubit>(
      () => _i27.ThemeCubit(themeStore: gh<_i17.IThemeStore>()));
  return getIt;
}
