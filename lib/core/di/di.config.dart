...
import 'package:dappstore/core/platform_channel/platform_channel_cubit.dart'
    as _i14;
import 'package:dappstore/core/theme/i_theme_cubit.dart' as _i29;
...
import 'package:dappstore/core/theme/theme_cubit.dart' as _i30;
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i23.WalletConnect>(() => _i23.WalletConnect());
  gh.lazySingleton<_i24.WalletConnectCubit>(() => _i24.WalletConnectCubit());
  gh.lazySingleton<_i25.IDownloader>(
      () => _i26.DownloaderCubit(permissionsCubit: gh<_i11.IPermissions>()));
  gh.lazySingleton<_i27.IForegroundService>(() => _i28.ForegroundService(
      platformChannelCubit: gh<_i13.IPlatformChannelCubit>()));
  gh.lazySingleton<_i29.IThemeCubit>(
      () => _i30.ThemeCubit(themeStore: gh<_i21.IThemeStore>()));
  return getIt;
}
