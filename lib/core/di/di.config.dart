...
import 'package:dappstore/core/installed_apps/installed_apps_cubit.dart'
    as _i13;
import 'package:dappstore/core/localisation/i_localisation_cubit.dart' as _i36;
import 'package:dappstore/core/localisation/localisation_cubit.dart' as _i37;
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i26.IStoreCubit>(
      () => _i27.StoreCubit(dappListRepo: gh<_i6.IDappListRepo>()));
  gh.lazySingleton<_i28.IThemeStore>(() => _i29.ThemeStore());
  gh.lazySingleton<_i30.WalletConnect>(() => _i30.WalletConnect());
  gh.lazySingleton<_i31.WalletConnectCubit>(() => _i31.WalletConnectCubit());
  gh.lazySingleton<_i32.IDownloader>(() => _i33.DownloaderCubit(
        permissionsCubit: gh<_i18.IPermissions>(),
        installerCubit: gh<_i14.IInstallerCubit>(),
      ));
  gh.lazySingleton<_i34.IForegroundService>(() => _i35.ForegroundService(
