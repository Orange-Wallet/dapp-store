...
import 'package:dappstore/core/installed_apps/installed_apps_cubit.dart'
    as _i13;
import 'package:dappstore/core/localisation/i_localisation_cubit.dart' as _i43;
import 'package:dappstore/core/localisation/localisation_cubit.dart' as _i44;
...
import 'package:dappstore/core/theme/i_theme_cubit.dart' as _i49;
import 'package:dappstore/core/theme/store/i_theme_store.dart' as _i32;
import 'package:dappstore/core/theme/store/theme_store.dart' as _i33;
import 'package:dappstore/core/theme/theme_cubit.dart' as _i50;
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i26.ISavedPwaPageHandler>(() => _i27.SavedPwaPageHandler());
  gh.lazySingleton<_i28.ISavedPwaStore>(
      () => _i29.SavedPwaStore(errorLogger: gh<_i10.IErrorLogger>()));
  gh.lazySingleton<_i30.IStoreCubit>(
      () => _i31.StoreCubit(dappListRepo: gh<_i8.IDappListRepo>()));
  gh.lazySingleton<_i32.IThemeStore>(() => _i33.ThemeStore());
  gh.lazySingleton<_i34.IWalletConnectStore>(
      () => _i35.WalletConnectStore(errorLogger: gh<_i10.IErrorLogger>()));
  gh.lazySingleton<_i36.WalletConnect>(() => _i36.WalletConnect());
  gh.lazySingleton<_i37.IDappInfoCubit>(
      () => _i38.DappInfoCubit(storeCubit: gh<_i30.IStoreCubit>()));
  gh.lazySingleton<_i39.IDownloader>(() => _i40.DownloaderCubit(
        permissionsCubit: gh<_i18.IPermissions>(),
        installerCubit: gh<_i14.IInstallerCubit>(),
      ));
  gh.lazySingleton<_i41.IForegroundService>(() => _i42.ForegroundService(
      platformChannelCubit: gh<_i20.IPlatformChannelCubit>()));
  gh.lazySingleton<_i43.ILocaleCubit>(
      () => _i44.LocaleCubit(localisationStore: gh<_i16.ILocalisationStore>()));
  gh.lazySingleton<_i45.IPackageManager>(() => _i46.PackageManager(
        gh<_i14.IInstallerCubit>(),
        gh<_i39.IDownloader>(),
        gh<_i41.IForegroundService>(),
        gh<_i12.IInstalledAppsCubit>(),
      ));
  gh.lazySingleton<_i47.ISavedPwaCubit>(
      () => _i48.SavedPwaCubit(savedPwaStore: gh<_i28.ISavedPwaStore>()));
  gh.lazySingleton<_i49.IThemeCubit>(
      () => _i50.ThemeCubit(themeStore: gh<_i32.IThemeStore>()));
  gh.lazySingleton<_i51.IWalletConnectCubit>(() => _i52.WalletConnectCubit(
        errorLogger: gh<_i10.IErrorLogger>(),
        wcStore: gh<_i34.IWalletConnectStore>(),
      ));
  gh.lazySingleton<_i53.IInjectedWeb3Cubit>(() => _i54.InjectedWeb3Cubit(
        signer: gh<_i51.IWalletConnectCubit>(),
        errorLogger: gh<_i10.IErrorLogger>(),
      ));
  return getIt;
}
