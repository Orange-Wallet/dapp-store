...
import 'package:dappstore/core/installed_apps/installed_apps_cubit.dart'
    as _i13;
import 'package:dappstore/core/localisation/i_localisation_cubit.dart' as _i41;
import 'package:dappstore/core/localisation/localisation_cubit.dart' as _i42;
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i32.IWalletConnectCubit>(
      () => _i33.WalletConnectCubit(errorLogger: gh<_i10.IErrorLogger>()));
  ...
  gh.lazySingleton<_i39.IInjectedWeb3Cubit>(() => _i40.InjectedWeb3Cubit(
        signer: gh<_i32.IWalletConnectCubit>(),
        errorLogger: gh<_i10.IErrorLogger>(),
      ));
  gh.lazySingleton<_i41.ILocaleCubit>(
      () => _i42.LocaleCubit(localisationStore: gh<_i16.ILocalisationStore>()));
  gh.lazySingleton<_i43.IPackageManager>(() => _i44.PackageManager(
