...
import 'package:dappstore/core/localisation/store/localisation_store.dart'
    as _i13;
import 'package:dappstore/core/permissions/i_permissions_cubit.dart' as _i14;
import 'package:dappstore/core/permissions/permissions_cubit.dart' as _i15;
...
import 'package:dappstore/core/theme/store/i_theme_store.dart' as _i24;
import 'package:dappstore/core/theme/store/theme_store.dart' as _i25;
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i12.ILocalisationStore>(() => _i13.LocalisationStore());
  gh.lazySingleton<_i14.IPermissions>(() => _i15.Permissions());
  gh.lazySingleton<_i16.IPlatformChannelCubit>(
      () => _i17.PlatformChannelCubit());
  gh.lazySingleton<_i18.IPwaWebviewCubit>(() => _i19.PwaWebviewCubit());
  gh.lazySingleton<_i20.IPwaWebviewHandler>(() => _i21.PwaWebviewHandler());
  gh.lazySingleton<_i22.IStoreCubit>(
      () => _i23.StoreCubit(dappListRepo: gh<_i6.IDappListRepo>()));
  gh.lazySingleton<_i24.IThemeStore>(() => _i25.ThemeStore());
  gh.lazySingleton<_i26.WalletConnect>(() => _i26.WalletConnect());
  gh.lazySingleton<_i27.WalletConnectCubit>(() => _i27.WalletConnectCubit());
  gh.lazySingleton<_i28.IDownloader>(
      () => _i29.DownloaderCubit(permissionsCubit: gh<_i14.IPermissions>()));
  gh.lazySingleton<_i30.IForegroundService>(() => _i31.ForegroundService(
      platformChannelCubit: gh<_i16.IPlatformChannelCubit>()));
  gh.lazySingleton<_i32.ILocaleCubit>(
      () => _i33.LocaleCubit(localisationStore: gh<_i12.ILocalisationStore>()));
  gh.lazySingleton<_i34.IThemeCubit>(
      () => _i35.ThemeCubit(themeStore: gh<_i24.IThemeStore>()));
  return getIt;
}
