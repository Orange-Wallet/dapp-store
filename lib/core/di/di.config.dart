...
import 'package:dappstore/core/installed_apps/installed_apps_cubit.dart'
    as _i13;
import 'package:dappstore/core/localisation/i_localisation_cubit.dart' as _i42;
import 'package:dappstore/core/localisation/localisation_cubit.dart' as _i43;
...
import 'package:dappstore/core/theme/i_theme_cubit.dart' as _i48;
...
import 'package:dappstore/core/theme/theme_cubit.dart' as _i49;
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i36.IDappInfoCubit>(
      () => _i37.DappInfoCubit(storeCubit: gh<_i30.IStoreCubit>()));
  gh.lazySingleton<_i38.IDownloader>(() => _i39.DownloaderCubit(
        permissionsCubit: gh<_i18.IPermissions>(),
        installerCubit: gh<_i14.IInstallerCubit>(),
      ));
  gh.lazySingleton<_i40.IForegroundService>(() => _i41.ForegroundService(
      platformChannelCubit: gh<_i20.IPlatformChannelCubit>()));
  gh.lazySingleton<_i42.ILocaleCubit>(
      () => _i43.LocaleCubit(localisationStore: gh<_i16.ILocalisationStore>()));
  gh.lazySingleton<_i44.IPackageManager>(() => _i45.PackageManager(
        gh<_i14.IInstallerCubit>(),
        gh<_i38.IDownloader>(),
        gh<_i40.IForegroundService>(),
        gh<_i12.IInstalledAppsCubit>(),
      ));
  gh.lazySingleton<_i46.ISavedPwaCubit>(
      () => _i47.SavedPwaCubit(savedPwaStore: gh<_i28.ISavedPwaStore>()));
  gh.lazySingleton<_i48.IThemeCubit>(
      () => _i49.ThemeCubit(themeStore: gh<_i32.IThemeStore>()));
  gh.lazySingleton<_i50.IWalletConnectCubit>(() => _i51.WalletConnectCubit(
        errorLogger: gh<_i10.IErrorLogger>(),
        wcStore: gh<_i34.IWalletConnectStore>(),
      ));
  gh.lazySingleton<_i52.IInjectedWeb3Cubit>(() => _i53.InjectedWeb3Cubit(
        signer: gh<_i50.IWalletConnectCubit>(),
        errorLogger: gh<_i10.IErrorLogger>(),
      ));
  return getIt;
}
