...
class SavedDappsPage extends StatefulScreen {
  ...
  @override
  State<StatefulWidget> createState() => _SavedDappsPageState();

  @override
  String get route => "/SavedDappsPage";
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: InScreenAppBar(
        themeSpec: theme,
        title: context.getLocale!.savedPwa,
      ),
      body: BlocBuilder<ISavedPwaCubit, SavedPwaState>(
